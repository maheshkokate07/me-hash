...
export default function ({
     ...
     return (
          <div
               style={{ height: `calc(100vh - ${headerHeight} - ${footerHeight})` }}
               className="max-w-3xl flex items-center justify-center flex-col mx-auto px-5 sm:px-6 py-8 sm:py-10"
          >
